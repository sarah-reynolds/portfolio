				...
				<div className="row">
					<div className="home-bg col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
						...
						<div className="col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center intro">
							<p>My name is Sarah and I'm a full-stack web developer based in Atlanta, GA. I have a keen eye for design, acute attention to detail, and exceptional organizational and communication skills.</p>
						</div>
