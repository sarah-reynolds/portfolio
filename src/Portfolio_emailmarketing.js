							...
							<h3 className="port-header">&nbsp;Email Marketing</h3>
								<div className="row">
									...
									<div className="col-md-5 col-md-offset-0 col-sm-10 col-sm-offset-1 col-xs-12">
										<a href="http://view.aadvantageeshopping.com/?j=fe5713757162057a771c&m=fe641570776002757512&ls=fdf7177073600d7c7614767d&l=fe5a1775766c0c7f7017&s=fe3013737663067f761070&jb=ff5e12727c&ju=fe221376756502787c1275&r=0" target="_blank"><img src="/images/mktgemail_screenshot.png" role="presentation" /></a>
									</div>
								</div>
							<div className="row">
								<div className="col-md-6 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12">
									...
									<ul>
										...
										<BtnExternal linkTo={"/images/confirmation_update.png"} buttonText={"View redesign"} /><br />
								</div>
								<div className="col-md-4 col-md-offset-0 col-sm-10 col-sm-offset-1 col-xs-12"><br />
									<a href="/images/confirmation_update.png" target="_blank"><img src="/images/confirmation_update.png" role="presentation" /></a>
								</div>
							</div>
